...
public class BrokerOnlineReqTO implements java.io.Serializable {
    ...
    public BrokerOnlineReqTO() {
    }

    public BrokerOnlineReqTO(String id, String name, String cluster, String ip, String domain, String cpu, String memory, BrokerStatusTO status) {
        this.id = id;
        this.name = name;
    ...
    public static class Builder {
        ...
        public BrokerOnlineReqTO build() {
            return new BrokerOnlineReqTO(id, name, cluster, ip, domain, cpu, memory, status);
        }
